...
const translations = {
  ...
  mr: {
    blessing: 'आमच्या कुटुंबियांच्या प्रेम व आशीर्वादासह',
    inviteText: 'आम्ही विवाहबद्ध होत आहोत; आमच्या या खास क्षणी आपण सहभागी व्हावे, ही मनःपूर्वक विनंती',
    dear: 'प्रिय',
    invitationMessage: 'आपली उपस्थिती आमच्या आनंदात भर घालेल',
    eventsTitle: 'विवाह सोहळा',
    ...
    withLove: 'With love',
    scrollText: 'आपली उपस्थिती अपेक्षित',
    date: 'तारीख',
    time: 'वेळ',
    may: 'मे',
    pm: 'सायंकाळी',
